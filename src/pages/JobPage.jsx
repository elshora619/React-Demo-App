...
const JobPage = ({deleteJob}) => {
  const navigate = useNavigate();
    ...
    // const [job, setJob] = useState(null); // State for storing job data
    ...
    //             setJob(data); // Set the job data after fetching
    //         } catch (error) {
    ...
    // If loading, show spinner, otherwise render the job details
    return (
        <>
        <section>
