...
const AddJobPage = ({ addJobSubmit }) => {
  ...
  const submitForm = (e) => {
    ...
    addJobSubmit(newJob); // ✅ Send data to parent (App.js)
    console.log('Job Added:', newJob);

    navigate('/jobs'); // ✅ Redirect user to Jobs page
  };
          ...
          <form onSubmit={submitForm}>
            ...
            <div className="mb-4">
              ...
              <textarea id="description" name="description" className="border rounded w-full py-2 px-3" rows="4"
                placeholder="Job responsibilities, qualifications, etc." required 
            ...
            <div className="mb-4">
              ...
              <input type="text" id="location" name="location" className="border rounded w-full py-2 px-3 mb-2"
            ...
            <div className="mb-4">
              ...
              <input type="text" id="company" name="company" className="border rounded w-full py-2 px-3"
            ...
            <div className="mb-4">
              ...
              <textarea id="company_description" name="company_description" className="border rounded w-full py-2 px-3" rows="4"
            ...
            <div className="mb-4">
              ...
              <input type="tel" id="contact_phone" name="contact_phone" className="border rounded w-full py-2 px-3"
